...
angular.module('eightfold', [
  ...
  'ngAnimate',
  'duScroll'
]).value('duScrollDuration', 1000).run([
  '$rootScope',
  function ($rootScope) {
...
angular.module('eightfold').directive('scrollReveal', [
  '$timeout',
  function ($timeout) {
    // Runs during compile
    return {
...
* Description
*/
angular.module('eightfold').directive('efPortfolio', [
  '$http',
  '$sce',
  function ($http, $sce) {
    // Runs during compile
    return {
      ...
      controller: [
        ...
        function ($scope, $element, $attrs, $transclude) {
          ...
          //Get portfolio data
          $http.get('js/portfolio/portfolio.json').success(function (data, status, headers, config) {
